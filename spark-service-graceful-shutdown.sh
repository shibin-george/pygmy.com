...
curl -m 5 -s -X GET http://$UI_IP:35650/stop > /dev/null
curl -m 5 -s -X GET http://$CATALOG_IP1:35640/stop > /dev/null
curl -m 5 -s -X GET http://$CATALOG_IP2:35640/stop > /dev/null
curl -m 5 -s -X GET http://$ORDER_IP1:35660/stop > /dev/null
